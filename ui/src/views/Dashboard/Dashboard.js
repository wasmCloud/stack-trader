                    ...
                    <ul>
                      ...
                      <div className="progress-group">
                        <div className="progress-group-header">
                          ...
                          <span className="title">The Void</span>
                      ...
                      <div className="progress-group">
                        <div className="progress-group-header">
                          <i className="icon-globe progress-group-icon"></i>
                          <span className="title">Main Lobby</span>
                      ...
                      <div className="progress-group">
                        <div className="progress-group-header">
                          <i className="icon-globe progress-group-icon"></i>
                          <span className="title">KubeCon 2019</span>
                      ...
                      <div className="progress-group">
                        <div className="progress-group-header">
                          <i className="icon-globe progress-group-icon"></i>
                          <span className="title">Load Testing</span>
                          <span className="ml-auto font-weight-bold">427,319 <span className="text-muted small">(89%)</span></span>
                        </div>
                        <div className="progress-group-bars">
                          <Progress className="progress-xs" color="success" value="89" />
                        </div>
                      </div>
